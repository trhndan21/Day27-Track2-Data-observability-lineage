...
def validate_orders_task() -> dict:
    """
    Thực thi quy trình kiểm tra dữ liệu:
    1. Lấy đường dẫn file input từ biến môi trường hoặc mặc định.
    2. Chạy quy trình kiểm tra (đọc, validate, ghi JSON, gửi Discord).
    3. Trả về bản tóm tắt kết quả.
    """
